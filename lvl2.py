...
class Level2:
    def __init__(self, screen):
        ...
        # GUI labels
        self.gui_source_label = "Sekolah"
        self.gui_destination_label = "Toko Buku"
        # Graph for the level
        self.graph = {
            "A": {"B": 2, "C": 4},
            "B": {"A": 2, "C": 3, "D": 8},
...
def main():
    ...
    pygame.display.set_caption("Gowes To School - Level 2")
